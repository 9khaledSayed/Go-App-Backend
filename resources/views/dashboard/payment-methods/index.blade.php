            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                        <a href="{{route('dashboard.payment-methods.create')}}" class="btn btn-primary font-weight-bolder">
											<span class="svg-icon svg-icon-md">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-4 my-2 my-md-0">
                                        <div class="input-icon">
                                            <input type="text" class="form-control" placeholder="بــحــث ..." id="generalSearch" />
                                            <span>
...
@endsection
@push('scripts')
    <script src="{{asset('js/datatables/payment-methods.js')}}"></script>
@endpush
