                        ...
                        <div class="wizard-nav">
                            <div class="wizard-steps px-8 py-8 px-lg-15 py-lg-3">
                                ...
                                <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                    <div class="wizard-label">
                                        <h3 class="wizard-title">
                                            <span>1. </span>تعديل المعلومات الأساسيه للفئه </h3>
                                ...
                                <div class="wizard-step" data-wizard-type="step">
                                    <div class="wizard-label">
                                        <h3 class="wizard-title">
                                            <span>2. </span>تعديل حصائض الفئه </h3>
                                        <div class="wizard-bar"></div>
                                    </div>
                                </div>
                                ...
                                <div class="wizard-step" data-wizard-type="step">
                                    <div class="wizard-label">
                                        <h3 class="wizard-title">
                                            <span>3. </span> تعديل الصور للفئه </h3>
                                        <div class="wizard-bar"></div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <form class="form" id="kt_form">
                                            ...
                                            <div class="form-group row mb-5">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="text" name="name" class="form-control"
                                                           placeholder="أدخل اسم الفئه" value="{{old('name') ?: $category['name']}}"/>
                                                    <div>
                                    ...
                                    <div class="d-flex justify-content-between border-top mt-5 p-10">
                                        <div class="mr-2">
                                            <button class="btn btn-light-primary font-weight-bold text-uppercase px-9 py-4" data-wizard-type="action-prev">الصفحه السابقه</button>
                                        </div>
                                        <div>
