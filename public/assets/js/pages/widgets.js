...
var KTWidgets = function() {
    ...
    var _initDaterangepicker = function() {
        ...
        picker.daterangepicker({
            ...
            endDate: end,
            opens: 'left',
            applyClass: 'btn-priمارسy',
            cancelClass: 'btn-light-priمارسy',
            ranges: {
                'Today': [moment(), moment()],
    ...
    var _initStatsWidget7 = function() {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو', 'Jul'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    var _initStatsWidget8 = function() {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    var _initStatsWidget9 = function() {
        ...
        var options = {
            ...
            stroke: {
                ...
                show: true,
                width: 3,
                colors: [KTApp.getSettings()['colors']['theme']['base']['priمارسy']]
            },
            xaxis: {
                categories: ['فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو'],
                axisBorder: {
            ...
            colors: [KTApp.getSettings()['colors']['theme']['light']['priمارسy']],
            مارسkers: {
                colors: [KTApp.getSettings()['colors']['theme']['light']['priمارسy']],
                strokeColor: [KTApp.getSettings()['colors']['theme']['base']['priمارسy']],
                strokeWidth: 3
            }
        };
    ...
    var _initStatsWidget10 = function() {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو', 'Jul', 'أغسطس'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    var _initStatsWidget11 = function() {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو', 'أغسطس', 'سبتمبر'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    var _initStatsWidget13 = function () {
        var element = document.getElementById("kt_stats_widget_13_chart");
        var height = parseInt(KTUtil.css(element, 'height'));
        var color = KTUtil.hasAttr(element, 'data-color') ? KTUtil.attr(element, 'data-color') : 'success';
    ...
    var _initChartsWidget5 = function() {
        ...
        var options = {
            ...
            colors: [KTApp.getSettings()['colors']['theme']['base']['info'], KTApp.getSettings()['colors']['theme']['base']['priمارسy']],
            grid: {
                borderColor: KTApp.getSettings()['colors']['gray']['gray-200'],
                strokeDashArray: 4,
                yaxis: {
    ...
    var _initChartsWidget6 = function() {
        ...
        var options = {
            ...
            colors: [KTApp.getSettings()['colors']['theme']['base']['info'], KTApp.getSettings()['colors']['theme']['base']['priمارسy'], KTApp.getSettings()['colors']['theme']['light']['priمارسy']],
            grid: {
                borderColor: KTApp.getSettings()['colors']['gray']['gray-200'],
                strokeDashArray: 4,
                yaxis: {
    ...
    var _initMixedWidget16 = function() {
        ...
        var options = {
            ...
            colors: [
                ...
                KTApp.getSettings()['colors']['theme']['base']['priمارسy']
            ],
            stroke: {
                lineCap: "round",
            },
        ...
        var options = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    track: {
                        background: KTApp.getSettings()['colors']['theme']['light']['priمارسy'],
                        strokeWidth: '100%'
                    }
                }
            },
    ...
    var _initTilesWidget1 = function() {
        ...
        var color = KTUtil.hasAttr(element, 'data-color') ? KTUtil.attr(element, 'data-color') : 'priمارسy';
        var height = parseInt(KTUtil.css(element, 'height'));
        ...
        var options = {
            ...
            xaxis: {
                categories: ['يناير', 'فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو', 'Jul', 'أغسطس', 'سبتمبر', 'أكتوبر', 'نوفمبر', 'ديسمبر'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    var _initTilesWidget5 = function() {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['فبراير', 'مارس', 'أبريل', 'مايو']
            },
            yaxis: {
                min: 0,
                max: 20
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: {
                        ...
                        value: {
                            color: KTApp.getSettings()['colors']['theme']['inverse']['priمارسy'],
                            fontSize: "22px",
                            fontWeight: "bold",
                            offsetY: -40,
                            show: true
                    ...
                    track: {
                        background: KTUtil.colorLighten(KTApp.getSettings()['colors']['theme']['base']['priمارسy'], 7),
                        strokeWidth: '100%'
                    }
                }
            },
            colors: [KTApp.getSettings()['colors']['theme']['inverse']['priمارسy']],
            stroke: {
                lineCap: "round",
            },
            labels: ["Progress"]
    ...
    var _initMixedWidget23 = function() {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['يناير, 2020', 'فبراير, 2020', 'مارس, 2020', 'أبريل, 2020', 'مايو, 2020', 'يونيو, 2020'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
