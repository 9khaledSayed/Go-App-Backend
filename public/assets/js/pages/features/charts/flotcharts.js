...
var KTFlotchartsDemo = function() {
    ...
    var demo8 = function() {
        var data = [
            {label: "جـــــده ", data: 120, color:  KTApp.getSettings()['colors']['theme']['base']["success"]},
            {label: "الــريــاض ", data: 240, color:  KTApp.getSettings()['colors']['theme']['base']["danger"]},
            {label: "المــديــنـه ", data: 380, color:  KTApp.getSettings()['colors']['theme']['base']["warning"]}
        ];
