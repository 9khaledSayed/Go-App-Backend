        ...
        var datatable = $('#kt_datatable').KTDatatable({
                        ...
                        swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    ...
                                    url: '/dashboard/payment-methods/' + data.id,
                                    error: function (err) {
            ...
            columns: [{
                ...
                template: function (row) {
                    if(row.status == 1)
                    {
                        return '<b class="text-success">متاح</b>';

                    }else
                    {
                        return '<b class="text-danger">غير متاح </b>';
                    }
                }
            },{
                field: 'Actions',
                ...
                template: function(row) {
                    return '\
                            <div class="dropdown dropdown-inline">\
                                <a href="/dashboard/payment-methods/' + row.id  + '" class="btn btn-sm btn-clean btn-icon mr-2" title="عـرض">\
                                 \<i class="flaticon-eye"></i>\
                                </a>\
                            </div>\
                            <a href="/dashboard/payment-methods/'+ row.id +'/edit" class="btn btn-sm btn-clean btn-icon mr-2" title="تعديل">\
