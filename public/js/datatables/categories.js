                ...
                rows: {
                    afterTemplate: function (row, data, index) {
                        row.find('.delete-sub-categpry').on('click', function () {
                            swal.fire({
                                text: "هـل أنـت متـأكد مـن حـذف هـذه الفئه ؟ ",
                                confirmButtonText: "نعــم, أمسح !",
                                icon: "warning",
                                confirmButtonClass: "btn font-weight-bold btn-danger",
                                showCancelButton: true,
                ...
                columns: [
                    {
                        ...
                        template: function(row) {
                            return '\
                        <div class="dropdown dropdown-inline">\
                            <a href="/admin/organization_doctors/' + row.id  + '" class="btn btn-sm btn-clean btn-icon mr-2" title="عـرض">\
                             \<i class="flaticon-eye"></i>\
                            </a>\
                        </div>\
                        <a href="/admin/organization_doctors/'+ row.id +'/edit" class="btn btn-sm btn-clean btn-icon mr-2" title="تعديل">\
                            <span class="svg-icon svg-icon-md">\
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                        <rect x="0" y="0" width="24" height="24"/>\
